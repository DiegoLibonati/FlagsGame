...
class TestTestingConfigInheritance:
    ...
    def test_inherits_json_as_ascii(self) -> None:
        assert TestingConfig.JSON_AS_ASCII == DefaultConfig.JSON_AS_ASCII

    def test_inherits_mongo_user(self) -> None:
        assert TestingConfig.MONGO_USER == DefaultConfig.MONGO_USER

    def test_inherits_mongo_pass(self) -> None:
        assert TestingConfig.MONGO_PASS == DefaultConfig.MONGO_PASS
