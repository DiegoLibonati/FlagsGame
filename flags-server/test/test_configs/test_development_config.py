...
class TestDevelopmentConfigInheritance:
    ...
    def test_inherits_mongo_user(self) -> None:
        assert DevelopmentConfig.MONGO_USER == DefaultConfig.MONGO_USER

    def test_inherits_mongo_pass(self) -> None:
        assert DevelopmentConfig.MONGO_PASS == DefaultConfig.MONGO_PASS
    ...
    def test_inherits_json_as_ascii(self) -> None:
        assert DevelopmentConfig.JSON_AS_ASCII == DefaultConfig.JSON_AS_ASCII
